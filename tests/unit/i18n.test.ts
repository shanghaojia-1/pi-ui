...
describe('theme catalog', () => {
  ...
  it('every theme has a translated label and a swatch', () => {
    ...
    expect(dongbeiYujie?.rightPanelArtwork).toContain('dongbei-yujie-right-panel.png')
    ...
    expect(hashimotoYuna?.rightPanelArtwork).toContain('hashimoto-yuna-right-panel.png')
    ...
    expect(mikamiYua?.rightPanelArtwork).toContain('mikami-yua-right-panel.png')
    expect(mikamiYua?.rightPanelArtworkPosition).toBe('80% center')
