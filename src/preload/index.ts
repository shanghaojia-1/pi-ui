...
const api: PiDesktopApi = {
  ...
  previewArtifact: (path: string) => ipcRenderer.invoke(IPC.artifactPreview, path),
  openArtifactExternal: (path: string) => ipcRenderer.invoke(IPC.artifactOpenExternal, path),
