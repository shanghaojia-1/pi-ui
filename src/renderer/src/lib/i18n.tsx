...
const DICT: Dict = {
  ...
  'settings.collapseProviderForm': { zh: '收起表单', en: 'Collapse form' },
  'settings.providersHint': { zh: '选择一个提供商进行配置；当前会话使用的模型仍由顶部选择器控制。', en: 'Pick a provider to configure; the active model is still controlled by the top selector.' },
  'settings.addCustom': { zh: '添加自定义', en: 'Add custom' },
  'settings.collapseForm': { zh: '收起表单', en: 'Collapse form' },
  'settings.noProviders': { zh: '未发现已配置的模型提供商。', en: 'No model providers configured.' },
  'settings.noProvidersHint': { zh: '可在终端运行 pi /login 登录，然后刷新模型列表。', en: 'Run pi /login in a terminal to sign in, then refresh the model list.' },
  'settings.refreshModels': { zh: '刷新模型列表', en: 'Refresh models' },
  'settings.refreshing': { zh: '刷新中…', en: 'Refreshing…' },
  'settings.searchProvider': { zh: '搜索提供商（名称或 ID）', en: 'Search providers (name or ID)' },
  'settings.searchAria': { zh: '搜索提供商', en: 'Search providers' },
  'settings.pinnedLabel': { zh: '已选（不在搜索结果中）', en: 'Selected (filtered out)' },
  'settings.searchEmpty': { zh: '未找到匹配的提供商', en: 'No matching providers' },
  'settings.keyTitle': { zh: 'API Key（仅本次运行）', en: 'API key (runtime only)' },
  'settings.selectProviderFirst': { zh: '请先在上方选择一个提供商。', en: 'Pick a provider above first.' },
  'settings.keyHint': { zh: '为 {name} 配置临时 API Key。仅本次运行有效，关闭应用后失效，不会写入磁盘。', en: 'Set a temporary API key for {name}. Valid only for this run; never written to disk.' },
  'settings.keyPlaceholder': { zh: '粘贴 API Key', en: 'Paste API key' },
  'settings.keyAria': { zh: 'API Key', en: 'API key' },
  'settings.setKey': { zh: '设置 Key', en: 'Set key' },
  'settings.settingKey': { zh: '设置中…', en: 'Setting…' },
  'settings.logout': { zh: '退出登录', en: 'Sign out' },
  'settings.confirmLogout': { zh: '再次点击确认退出', en: 'Click again to confirm' },
  'settings.keySuccess': { zh: 'API Key 已设置（仅本次运行，关闭应用后失效）', en: 'API key set (runtime only)' },
  'settings.keySetting': { zh: '正在设置 API Key…', en: 'Setting API key…' },
  'settings.loggingOut': { zh: '正在退出登录…', en: 'Signing out…' },
  'settings.loggedOut': { zh: '已退出登录', en: 'Signed out' },
  ...
  'settings.defaultsHint': { zh: '默认值用于新会话；当前会话模型仍由顶部选择器控制。', en: 'Defaults apply to new sessions; the active model is still top-selector controlled.' },
  'settings.defaultProvider': { zh: '默认提供商', en: 'Default provider' },
  ...
  'settings.providerDefault': { zh: '提供商默认', en: 'Provider default' },
  ...
  'settings.providerSearchEmpty': { zh: '未找到匹配的提供商', en: 'No matching providers' },
  ...
  'settings.modelsListHint': { zh: '逐个添加此供应商提供的模型。', en: 'Add the models this provider serves, one by one.' },
  'settings.modelIdPh': { zh: '模型 ID，如 llama3.1:8b', en: 'Model ID, e.g. llama3.1:8b' },
  'settings.modelIdAria': { zh: '模型 ID', en: 'Model ID' },
  'settings.modelNamePh': { zh: '显示名（可选）', en: 'Display name (optional)' },
