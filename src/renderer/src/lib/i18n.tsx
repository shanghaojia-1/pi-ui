...
const DICT: Dict = {
  ...
  'settings.engineHint': { zh: 'Pi 引擎随应用内置。可在此安装其他版本（需要 npm）；切换后重启生效。', en: 'The Pi engine is bundled with the app. Install other versions here (requires npm); restart to apply a switch.' },
  'settings.engine.current': { zh: '当前引擎', en: 'Current engine' },
  'settings.engine.builtin': { zh: '内置', en: 'Builtin' },
  ...
  'settings.engine.noneInstalled': { zh: '未安装外部引擎', en: 'No external engines installed' },
  ...
  'settings.engine.deactivated': { zh: '已恢复内置引擎，重启后生效', en: 'Reverted to the builtin engine — restart to apply' },
  'settings.engine.deleted': { zh: '已删除引擎 {version}', en: 'Engine {version} deleted' },
  'settings.engine.deactivate': { zh: '恢复内置', en: 'Revert to builtin' },
